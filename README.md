...
1. Select _Open Distro for Elasticsearch_ from the _Type_ dropdown.
...
![Elasticsearch data source details](https://github.com/grafana/open-distro-for-elasticsearch-grafana-datasource/blob/master/docs/img/elasticsearch-details.png)
...
![Elasticsearch Query Editor](https://github.com/grafana/open-distro-for-elasticsearch-grafana-datasource/blob/master/docs/img/query-editor.png)
...
![Pipeline aggregation editor](https://github.com/grafana/open-distro-for-elasticsearch-grafana-datasource/blob/master/docs/img/pipeline-aggregation-editor.png)
...
![Query with template variables](https://github.com/grafana/open-distro-for-elasticsearch-grafana-datasource/tree/master/docs/img/templating-query.png)
...
![SigV4 configuration for AWS Elasticsearch Service](https://github.com/grafana/open-distro-for-elasticsearch-grafana-datasource/blob/master/docs/img/sigv4.png)
