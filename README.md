...
![Elasticsearch data source details](./docs/img/elasticsearch-details.png)
...
![Elasticsearch Query Editor](./docs/img/query-editor.png)
...
![Pipeline aggregation editor](./docs/img/pipeline-aggregation-editor.png)
...
![Query with template variables](./docs/img/templating-query.png)
...
![SigV4 configuration for AWS Elasticsearch Service](./docs/img/sigv4.png)
